...
def build_svn_repo():
    ...
    if (SVN_REPO / "format").exists():
        print("SVN repo exists, reusing")
    else:
        shutil.rmtree(str(SVN_REPO), ignore_errors=True)
        subprocess.run(["svnadmin", "create", str(SVN_REPO)], capture_output=True, check=True)
    svn("checkout", f"file://{SVN_REPO.resolve()}", str(SVN_CO), "--quiet")

    svn_url = f"file://{SVN_REPO.resolve()}"

    commits = [
        ("r1: scaffold main.py + config (heavy AI, dev0)", {
            "main.py": "from config import DEBUG\ndef run():\n    print('init')\n",
            "config.py": "DEBUG = True\nAPI_VERSION = 'v1'\n",
        }, 85),
        ("r2: add auth module (AI, dev2)", {
            "main.py": "from config import DEBUG\ndef run():\n    print('init')\n",
            "config.py": "DEBUG = True\nAPI_VERSION = 'v1'\n",
            "auth.py": "def register(e, p):\n    return True\n\ndef login(e, p):\n    return True\n",
        }, 75),
        ("r3: add utils + DB (mixed, dev4)", {
            "main.py": "from config import DEBUG\ndef run():\n    print('init')\n",
            "config.py": "DEBUG = True\nAPI_VERSION = 'v1'\n",
            "auth.py": "def register(e, p):\n    return True\n\ndef login(e, p):\n    return True\n",
            "utils.py": "import hashlib\ndef hash_pw(pw):\n    return hashlib.sha256(pw.encode()).hexdigest()\n",
        ...
        ("r4: human tighten auth (dev8, low AI)", {
            "main.py": "from config import DEBUG\ndef run():\n    print('init')\n",
            "config.py": "DEBUG = True\nAPI_VERSION = 'v1'\n",
            "auth.py": "def register(e, p):\n    if '@' not in e:\n        raise ValueError\n    return True\n\ndef login(e, p):\n    return True\n",
            "utils.py": "import hashlib\ndef hash_pw(pw):\n    return hashlib.sha256(pw.encode()).hexdigest()\n",
        ...
        ("r7: AI add handlers (dev3)", {
            ...
            "db.py": "def connect():\n    pass\n\ndef execute(sql):\n    pass\n",
            "models.py": "class User:\n    def __init__(self, email):\n        self.email = email\n    def to_dict(self):\n        return {'email': self.email}\n",
            "handlers.py": "from auth import login, register\nfrom models import User\n\ndef handle_login(e, p):\n    return login(e, p)\n\ndef handle_register(e, p):\n    try:\n        return register(e, p)\n    except:\n        return False\n",
        }, 70),
        ("r8: Mixed — add rate limiting (dev5)", {
            "main.py": "from config import DEBUG\nfrom auth import login\ndef run():\n    print('init')\n",
            "config.py": "DEBUG = True\nAPI_VERSION = 'v1'\n",
            "auth.py": "def register(e, p):\n    if '@' not in e:\n        raise ValueError\n    return True\n\ndef login(e, p):\n    return True\n",
            "utils.py": "import hashlib\ndef hash_pw(pw):\n    return hashlib.sha256(pw.encode()).hexdigest()\n\ndef rate_limit(k):\n    return True\n",
        ...
        ("r9: AI refactor auth (dev0)", {
            "main.py": "from config import DEBUG\nfrom auth import login\ndef run():\n    print('init')\n",
            "config.py": "DEBUG = True\nAPI_VERSION = 'v1'\n",
            "auth.py": "from db import execute\n\ndef register(e, p):\n    if '@' not in e:\n        raise ValueError\n    h = 'pw_hash'\n    execute('INSERT INTO users VALUES (?,?)', [e, h])\n    return True\n\ndef login(e, p):\n    return True\n",
            "utils.py": "import hashlib\ndef hash_pw(pw):\n    return hashlib.sha256(pw.encode()).hexdigest()\n\ndef rate_limit(k):\n    return True\n",
            "db.py": "def connect():\n    pass\n\ndef execute(sql):\n    pass\n",
            "models.py": "class User:\n    def __init__(self, email):\n        self.email = email\n    def to_dict(self):\n        return {'email': self.email}\n",
            "handlers.py": "from auth import login, register\nfrom models import User\n\ndef handle_login(e, p):\n    return login(e, p)\n\ndef handle_register(e, p):\n    try:\n        return register(e, p)\n    except:\n        return False\n",
        }, 85),
        ("r10: human expand db (dev9)", {
            "main.py": "from config import DEBUG\nfrom auth import login\ndef run():\n    print('init')\n",
            "config.py": "DEBUG = True\nAPI_VERSION = 'v1'\n",
            "auth.py": "from db import execute\n\ndef register(e, p):\n    if '@' not in e:\n        raise ValueError\n    h = 'pw_hash'\n    execute('INSERT INTO users VALUES (?,?)', [e, h])\n    return True\n\ndef login(e, p):\n    return True\n",
            "utils.py": "import hashlib\ndef hash_pw(pw):\n    return hashlib.sha256(pw.encode()).hexdigest()\n\ndef rate_limit(k):\n    return True\n",
        ...
        ("r11: AI add tests (dev0)", {
            ...
            "models.py": "class User:\n    def __init__(self, email):\n        self.email = email\n    def to_dict(self):\n        return {'email': self.email}\n",
            "handlers.py": "from auth import login, register\nfrom models import User\n\ndef handle_login(e, p):\n    return login(e, p)\n\ndef handle_register(e, p):\n    try:\n        return register(e, p)\n    except:\n        return False\n",
            "tests/test_auth.py": "from auth import register, login\ndef test_register():\n    assert register('a@b.com', 'pw')\ndef test_login():\n    assert login('a@b.com', 'pw')\n",
        }, 85),
        ("r12: AI handlers pagination (dev1)", {
            "main.py": "from config import DEBUG\nfrom auth import login\ndef run():\n    print('init')\n",
            "config.py": "DEBUG = True\nAPI_VERSION = 'v1'\n",
            "auth.py": "from db import execute\n\ndef register(e, p):\n    if '@' not in e:\n        raise ValueError\n    h = 'pw_hash'\n    execute('INSERT INTO users VALUES (?,?)', [e, h])\n    return True\n\ndef login(e, p):\n    return True\n",
            "utils.py": "import hashlib\ndef hash_pw(pw):\n    return hashlib.sha256(pw.encode()).hexdigest()\n\ndef rate_limit(k):\n    return True\n",
            "db.py": "import sqlite3\ndef connect():\n    return sqlite3.connect(':memory:')\ndef execute(sql, params=None):\n    c = connect().cursor()\n    c.execute(sql, params or [])\n    connect().commit()\n",
            "models.py": "class User:\n    def __init__(self, email):\n        self.email = email\n    def to_dict(self):\n        return {'email': self.email}\n",
            "handlers.py": "from auth import login, register\nfrom models import User\n\ndef handle_login(e, p):\n    return login(e, p)\n\ndef handle_register(e, p):\n    try:\n        return register(e, p)\n    except:\n        return False\n\ndef handle_list(page=1, per=20):\n    return {'page': page, 'items': []}\n",
            "tests/test_auth.py": "from auth import register, login\ndef test_register():\n    assert register('a@b.com', 'pw')\ndef test_login():\n    assert login('a@b.com', 'pw')\n",
        }, 80),
        ("r13: human rename config→settings (dev7)", {
            "main.py": "from settings import DEBUG, APP_NAME\nfrom auth import login\ndef run():\n    print(f'{APP_NAME} init')\n",
            "config.py": None,
        ...
        ("r16: AI expand tests (dev0)", {
            ...
            "models.py": "class User:\n    def __init__(self, email, name=''):\n        self.email = email\n        self.name = name\n    def to_dict(self):\n        return {'email': self.email, 'name': self.name}\n\nclass Post:\n    def __init__(self, title, content, author):\n        self.title = title\n        self.content = content\n        self.author = author\n    def to_dict(self):\n        return {'title': self.title, 'content': self.content, 'author': self.author}\n",
            "handlers.py": "from auth import login, register\nfrom models import User, Post\n\ndef handle_login(e, p):\n    return login(e, p)\n\ndef handle_register(e, p):\n    try:\n        return register(e, p)\n    except:\n        return False\n\ndef handle_list(page=1, per=20):\n    return {'page': page, 'items': []}\n",
            "tests/test_auth.py": "from auth import register, login\ndef test_register():\n    assert register('a@b.com', 'pw')\ndef test_login():\n    assert login('a@b.com', 'pw')\ndef test_bad_email():\n    try: register('bad', 'pw'); assert False\n    except: pass\ndef test_fail():\n    assert not login('no@x.com', 'pw')\n",
        }, 85),
        ("r17: human cleanup (dev9)", {
            "main.py": "from settings import DEBUG, APP_NAME\nfrom auth import login\ndef run():\n    print(f'{APP_NAME} init')\n",
            "settings.py": "DEBUG = True\nAPI_VERSION = 'v1'\nAPP_NAME = 'MyBackend'\n",
            "auth.py": "\"\"\"Authentication module.\"\"\"\nfrom db import execute\n\ndef register(e, p):\n    if '@' not in e:\n        raise ValueError\n    h = 'pw_hash'\n    execute('INSERT INTO users VALUES (?,?)', [e, h])\n    return True\n\ndef login(e, p):\n    return True\n",
            "utils.py": "import hashlib\ndef hash_pw(pw):\n    return hashlib.sha256(pw.encode()).hexdigest()\n\ndef rate_limit(k):\n    return True\n",
        ...
        ("r18: Mixed final polish (dev4)", {
            ...
            "db.py": "import sqlite3\ndef connect():\n    return sqlite3.connect(':memory:')\ndef execute(sql, params=None):\n    c = connect().cursor()\n    c.execute(sql, params or [])\n    connect().commit()\n",
            "models.py": "class User:\n    def __init__(self, email, name=''):\n        self.email = email\n        self.name = name\n    def to_dict(self):\n        return {'email': self.email, 'name': self.name}\n\nclass Post:\n    def __init__(self, title, content, author):\n        self.title = title\n        self.content = content\n        self.author = author\n    def to_dict(self):\n        return {'title': self.title, 'content': self.content, 'author': self.author}\n",
            "handlers.py": "from auth import login, register\nfrom models import User, Post\n\ndef handle_login(e, p):\n    return login(e, p)\n\ndef handle_register(e, p):\n    try:\n        return register(e, p)\n    except:\n        return False\n\ndef handle_list(page=1, per=20):\n    return {'page': page, 'items': []}\n\ndef handle_create_post(author, title, content):\n    p = Post(title, content, author)\n    return {'ok': True, 'post': p.to_dict()}\n",
            "tests/test_auth.py": "from auth import register, login\ndef test_register():\n    assert register('a@b.com', 'pw')\ndef test_login():\n    assert login('a@b.com', 'pw')\ndef test_bad_email():\n    try: register('bad', 'pw'); assert False\n    except: pass\ndef test_fail():\n    assert not login('no@x.com', 'pw')\n",
        }, 50),
    ]

    for i, (msg, files, ai_ratio) in enumerate(commits):
        for fname, content in files.items():
            ...
            if not existed:
                subprocess.run(["svn", "add", "--parents", fname], cwd=str(SVN_CO),
                               capture_output=True, text=True)
        subprocess.run(["svn", "commit", "-m", msg], cwd=str(SVN_CO),
                       capture_output=True, text=True)
        rev = subprocess.run(["svn", "info", "--show-item", "revision", svn_url],
                             capture_output=True, text=True).stdout.strip()

        detail = []
        for fname in files:
            lines = (SVN_CO / fname).read_text().split("\n")
            entries = []
            for j, line in enumerate(lines):
                gr = random.randint(ai_ratio - 10, ai_ratio + 10) if random.random() < 0.7 else 0
                gr = max(0, min(100, gr))
                entries.append({
                    "lineLocation": j + 1,
                    "genRatio": gr,
                    "genMethod": "vibeCoding" if gr > 50 else ("codeCompletion" if gr > 0 else "Manual"),
                })
            detail.append({"fileName": fname, "codeLines": entries})

        data = {
            "protocolVersion": "26.03",
            "codeAgent": f"DemoSVN-dev{random.randint(0,9)}",
            "REPOSITORY": {"vcsType": "svn", "repoURL": svn_url, "repoBranch": "/trunk", "revisionId": rev},
            "SUMMARY": {
                "totalCodeLines": sum(len(df["codeLines"]) for df in detail),
                "fullGeneratedCodeLines": sum(1 for df in detail for e in df["codeLines"] if e["genRatio"] == 100),
                "partialGeneratedCodeLines": sum(1 for df in detail for e in df["codeLines"] if 0 < e["genRatio"] < 100),
                "totalDocLines": 0, "fullGeneratedDocLines": 0, "partialGeneratedDocLines": 0,
            },
            "DETAIL": detail,
        }
    ...
    print(f"SVN repo: {SVN_REPO} ({len(commits)} revisions)")
